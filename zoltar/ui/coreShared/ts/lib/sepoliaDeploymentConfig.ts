...
import { GenesisReputationToken_GenesisReputationToken, infrastructure_WETH9_WETH9 } from '../contractArtifact.js'
...
export const SEPOLIA_WETH_INIT_CODE = `0x${infrastructure_WETH9_WETH9.evm.bytecode.object}` satisfies Hex
